...
final class GeminiAnswerPlanPromptBuilder {
    ...
    static String build(AiEpisodeDraftRequest request) {
        return """
                ...
                - For route, transit, tourism-change, old-house reuse, and street-history anchors, choose carriers from signs, guide ropes, railings, steps, gates, locks, route barriers, vehicle-adjacent fixtures, route maps, guide sheets, tickets, tools, stalls, carts, or handled fixtures.
                - For institutional, cultural, commercial, or preservation anchors, choose carriers from the concrete nouns found in the current anchors first. If the current anchors do not name an object, use an era-appropriate fixture, tool, container, machine, display frame, shelf, ladder, seal, cabinet, stall, or handled storage object.
