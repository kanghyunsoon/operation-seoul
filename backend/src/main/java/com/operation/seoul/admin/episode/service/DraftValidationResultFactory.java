...
final class DraftValidationResultFactory {
    ...
    static AiEpisodeDraftValidationResponse build(List<AiEpisodeDraftValidationResponse.Finding> findings) {
        ...
        return AiEpisodeDraftValidationResponse.builder()
                ...
                .publishChecklist(List.of(
                        ...
                        "8개 조사 단서는 하나의 사건 진실로 수렴해야 하며 범인, 흉기, 동기, 사인을 모두 추론할 수 있어야 합니다.",
    ...
    static String koreanFindingMessage(String code, String fallback) {
        return switch (code) {
            case "FOUR_FINAL_KEYWORD_ITEMS_REQUIRED" -> "finalAnswerKeywordItems에는 범인, 흉기, 동기, 사인 4개 슬롯과 값이 모두 필요합니다.";
            ...
            case "TARGET_KEYWORD_TYPE_REQUIRED" -> "조사 단서는 범인, 흉기, 동기, 사인 중 하나의 정답 슬롯에 연결되어야 합니다.";
            ...
            case "ANSWER_SLOT_EXACT_SUPPORT_REQUIRED" -> "8개 조사 단서가 범인, 흉기, 동기, 사인을 각각 2개씩 지원해야 합니다.";
            ...
            case "FINAL_TRUTH_MUST_EXPLAIN_ANSWERS" -> "진실 요약에는 범인, 흉기, 동기, 사인 4개 정답을 모두 설명해야 합니다.";
            case "EPISODE_TITLE_REQUIRED" -> "에피소드 제목이 필요합니다.";
            case "FICTION_SYNOPSIS_REQUIRED" -> "가상 사건 개요가 필요합니다.";
            case "FINAL_TRUTH_SUMMARY_REQUIRED" -> "최종 진실 요약에는 범인, 흉기, 동기, 사인을 설명해야 합니다.";
            ...
            case "INVALID_FINAL_ANSWER_KEYWORDS" -> "최종 정답 키워드는 범인, 흉기, 동기, 사인 4개를 모두 포함해야 합니다.";
            default -> fallback;
        };
    }
}
