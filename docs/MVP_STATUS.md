...
MVP 기능 개발은 현재 멈출 수 있는 상태입니다. 인증, 미션 파일 플레이, 지도, 도착 판정, 퍼즐, reward_payload 해금, 미션 파일 탭, 최종 추리, 클리어 리포트, CLEARED 기준 리뷰, 관리자 에피소드 생성/공개 QA는 구현되어 있습니다.
