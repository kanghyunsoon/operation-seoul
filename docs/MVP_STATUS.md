...
다만 일정, 팔로우/그룹, 챌린지/랭킹, 사용자 AI 추천, AI 코칭/분석은 아직 구현되지 않았습니다.
...
아래 항목은 문서에 계획은 있으나 실제 전용 Controller/API/View가 없습니다.
...
7. OAuth 소셜 로그인
8. 실제 쿠폰/상품권 지급
9. 다국어/무장애/두루누비/기상청 API 연계
10. 사용자 생성 사건파일/UGC 제작자 생태계
