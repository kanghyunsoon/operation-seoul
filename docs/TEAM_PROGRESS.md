...
- 일정, 팔로우, 그룹, 랭킹, 챌린지, 사용자 추천, 플레이 코칭/분석은 MVP API와 화면이 구현됐습니다.
- 남은 항목은 대부분 실제 모바일/현장 QA, 운영 검수, 외부 제휴/공공 API 연계입니다.
...
1. 실제 제휴 쿠폰/상품권 지급
2. 다국어/무장애/두루누비/기상청 API 연계
3. Gemini 기반 최종 추리 고도화
4. Gemini 기반 추천/코칭 개인화 고도화
5. 일정/그룹/챌린지 운영 UI와 알림 고도화
