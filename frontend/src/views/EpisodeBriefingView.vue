...
.briefing-card { width: min(100%, 700px); box-sizing: border-box; padding: 26px; border: 1px solid rgba(248,113,113,.28); border-radius: 24px; background: rgba(15,23,42,.84); box-shadow: 0 30px 80px rgba(0,0,0,.36); }
.label { color: #fca5a5; font-weight: 900; letter-spacing: .16em; font-size: .76rem; }
h1 { margin: 0 0 16px; font-size: clamp(1.9rem, 9vw, 3.7rem); line-height: 1; }
.synopsis { color: #dbeafe; line-height: 1.8; }
